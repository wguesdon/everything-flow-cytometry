...
| `reports/omip51_bcell_dc.qmd` | FR-FCM-ZYN4, OMIP-051 | A panel whose marker names are ambiguous, and a threshold taken from an unstained control |
...
| `reports/` | Ten reports render and their scripts run in the container. The prose of the first eight was written by kimi-k3 through opencode, against a brief that is kept outside this repository. |
